...
{
    //Static Always Taken
    //branch_predictors.push_back(new StaticATPredictor());
    //branch_predictors.push_back(new StaticBTFNT());
    // branch_predictors.push_back(new LocalTwoLevel(8192,2048,16));
    // branch_predictors.push_back(new LocalTwoLevel(512,4096,4));

    branch_predictors.push_back(new LocalTwoLevel(32,2048,8));
    branch_predictors.push_back(new LocalTwoLevel(512,4096,4));
    
    // branch_predictors.push_back(new LocalTwoLevel(8192,4096,8));
